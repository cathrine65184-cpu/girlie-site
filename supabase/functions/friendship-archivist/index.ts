...
Return valid JSON only. For mode "interview", return {"reply": string, "extraction": {"title"?: string, "friend_name"?: string, "location"?: string, "how_met"?: string, "first_memory"?: string, "themes"?: string[], "timeline"?: [{"date"?: string,"title": string,"note": string}], "places"?: [{"name": string,"note": string}], "objects"?: [{"name": string,"note": string}], "keywords"?: string[], "quote"?: string}}. Extract only facts explicitly supplied in the conversation.
