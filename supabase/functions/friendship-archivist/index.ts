...
Return valid JSON only. For mode "interview", return {"reply": string, "extraction": {"title"?: string, "friend_name"?: string, "location"?: string, "how_met"?: string, "first_memory"?: string, "friendship_start_date"?: string, "themes"?: string[], "timeline"?: [{"date"?: string,"title": string,"note": string}], "places"?: [{"name": string,"note": string}], "objects"?: [{"name": string,"note": string}], "keywords"?: string[], "quote"?: string}}. Extract only facts explicitly supplied in the conversation. Only include friendship_start_date when the user gave an unambiguous calendar year or date; never set it yourself or claim it has been saved.
For mode "finalize", return {"title"?: string, "friend_name"?: string, "location"?: string, "how_met"?: string, "first_memory"?: string, "themes"?: string[], "story": string, "timeline": [], "places": [], "objects": [], "keywords": [], "quote": string, "letter": string}. The story must be 300-800 words, literary but factual, and include no detail that the user did not supply. Label the letter as AI-assisted. If there is insufficient detail, say so plainly rather than inventing.`;
