...
const copy = {
  en: {
    ...
    howWorksTitle: 'Your friendship, remembered.', howExploreNumber: '01 — Explore', howExploreTitle: 'Friendship Museum', howExploreBody: 'Discover stories, memories and friendships from girls around the world. Tap any flower to read the friendship story it holds.',
    howCreateNumber: '02 — Create Your Space', howCreateTitle: '🏠 Private Girlie', howCreateBody: 'Create a private home for your friendship. A place for the memories, moments, photos and little things that belong to you two.',
    howTalkNumber: '03 — Tell Your Story', howTalkTitle: '🧠 AI Friendship Interview', howTalkBody: 'Let AI help you make sense of your friendship. Through a gentle conversation, AI asks about the moments that shaped your friendship — then helps you turn them into memories worth keeping.',
    howGrowNumber: '04 — Watch It Grow', howGrowTitle: '⏳ Friendship Timeline', howGrowBody: 'Your story becomes a living archive. The memories you share with AI become milestones, stories and moments inside your Private Girlie.',
    exploreTimeline: 'Explore Your Timeline',
    ...
    storyBridge: 'Museum → Private Girlie → AI Interview → Timeline', storyJourney: 'Girlie friendship journey', promisePreserved: 'A promise preserved in the archive',
    ...
    readyToRemember: 'Your friendship is taking shape →', writeAnything: 'Write as much or as little as you want…', leaveUnwritten: 'Leave this part unwritten', continue: 'Continue', skip: 'I’d rather leave that part unwritten.', friendshipDateSuggestion: 'It sounds like your friendship began in {year}. Would you like to use {year} as the beginning of your friendship timeline?', useYear: 'Use {year}', chooseAnotherDate: 'Choose another date',
  ...
  zh: {
    ...
    howWorksTitle: '让友谊被好好记住。', howExploreNumber: '01 — 探索', howExploreTitle: '友谊博物馆', howExploreBody: '发现来自世界各地女孩的故事、回忆与友谊。点击任意一朵花，阅读它珍藏的友谊故事。',
    howCreateNumber: '02 — 创建你们的空间', howCreateTitle: '🏠 私密 Girlie', howCreateBody: '为你们的友谊创建一座私密小屋。回忆、瞬间、照片和只属于你们的小事，都可以住在这里。',
    howTalkNumber: '03 — 讲讲你们的故事', howTalkTitle: '🧠 AI 友谊访谈', howTalkBody: '让 AI 帮你梳理这段友谊。它会在温柔的对话中问起塑造你们关系的时刻，再帮你把它们变成值得珍藏的记忆。',
    howGrowNumber: '04 — 看着它慢慢生长', howGrowTitle: '⏳ 友谊时间线', howGrowBody: '你们的故事会成为一份持续生长的档案。你与 AI 分享的记忆，会在私密 Girlie 里成为里程碑、故事和片段。',
    exploreTimeline: '查看你们的时间线',
    ...
    storyBridge: '博物馆 → 私密 Girlie → AI 访谈 → 时间线', storyJourney: 'Girlie 友谊旅程', promisePreserved: '档案中珍藏的约定',
    ...
    readyToRemember: '你们的友谊正在成形 →', writeAnything: '想写多少都可以…', leaveUnwritten: '这部分暂时不写', continue: '继续', skip: '这部分我想暂时不写。', friendshipDateSuggestion: '听起来你们的友谊始于 {year}。要把 {year} 作为友谊时间线的开始吗？', useYear: '使用 {year}', chooseAnotherDate: '选择其他日期',
